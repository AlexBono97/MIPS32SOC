...
module DIG_ROM_1024X32 (
    ...
    initial begin
        my_rom[0] = 32'h24080004;
        my_rom[1] = 32'h1d000002;
        my_rom[2] = 32'h240800aa;
        my_rom[3] = 32'h8100007;
        my_rom[4] = 32'h3c08aabb;
        my_rom[5] = 32'h3508ccdd;
        my_rom[6] = 32'h8100001;
        my_rom[7] = 32'h8100007;
    end
endmodule
...
begin
    if(beq & zero)
        ...
        bt=1'b1;
    else if(blez & (sign==1'b1 | zero==1'b1))
        bt=1'b1;
...
module testbgtz (
  ...
  // branchresolver
  branchresolver branchresolver_i29 (
    .beq( branch ),
    .bne( branche ),
    .bgez( bgez ),
    .bgtz( bgtz ),
  ...
  assign datamEn = s18[0];
  assign VGAEn = s18[1];
  assign IOEn = s18[2];
  assign offs = phyAddr[1:0];
  assign s25 = phyAddr[12:2];
  assign s27 = regA[31];
  DemuxBus2 #(
    .Bits(11)
  )
